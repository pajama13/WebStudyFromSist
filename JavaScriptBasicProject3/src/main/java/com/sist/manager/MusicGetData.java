...
public class MusicGetData {
	public static void main(String[] args) {
		try
		{
			...
			Elements poster=doc.select("div.newest-list table.list-wrap a.cover");
