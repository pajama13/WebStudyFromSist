...
<body>
  <div class="container">
    <h1>글쓰기</h1>
    <div class="row">
     <form method=post action="insert_ok.jsp"> <%-- form태그가 감싼 부분만 데이터가 넘어감, 필요한 만큼 감싸기 --%>
      <table class="table">
        <tr>
        ...
        <tr>
          <td colspan=2 class="text-center">
            ...
            <input type=button class="btn btn-sm btn-warning" onclick="javascript:history.back()" value="취소"> <%--이전화면 이동 --%>
          </td>
        </tr>
      </table>
     </form>
